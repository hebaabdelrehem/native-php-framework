<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-12-08 13:26:53
         compiled from "C:\xampp\htdocs\minative\plugins\news\templates\sections-edit.html" */ ?>
<?php /*%%SmartyHeaderCode:211115663447eee55c7-31271651%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd7c2ad69441aa6001d70da87bbe8011a8dd7d3c' => 
    array (
  ...
  'nocache_hash' => '211115663447eee55c7-31271651',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5663447f11e0a5_57885314',
  'variables' => 
  array (
    'sectionName' => 0,
    'languages' => 0,
...
<?php if ($_valid && !is_callable('content_5663447f11e0a5_57885314')) {function content_5663447f11e0a5_57885314($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("file:[11]head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						 Edit section : <?php echo $_smarty_tpl->tpl_vars['sectionName']->value;?>
...
" role="tab" data-toggle="tab"><?php echo $_smarty_tpl->tpl_vars['language']->value['name'];?>
							...
							<form role="form" id="editSection" name="editSection" action="" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['secId']->value;?>
" name="secId" />
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active" id="en">
										...
										<div class="form-group">
											...
											<input class="form-control" placeholder="" name="sectionName" value="<?php echo $_smarty_tpl->tpl_vars['sectionName']->value;?>
">
											<dfn>The main title of the page that will viewed to users.</dfn>
										</div>
										<div class="form-group">
											<label>Section description</label>
											<textarea class="form-control" rows="3" name="sectionDescrip"><?php echo $_smarty_tpl->tpl_vars['sectionDescrip']->value;?>
</textarea>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input class="form-control" placeholder="" type="text" name="sectionMetadisc"  value="<?php echo $_smarty_tpl->tpl_vars['sectionMetadisc']->value;?>
">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input class="form-control" placeholder="" type="text" name="sectionMetakey"  value="<?php echo $_smarty_tpl->tpl_vars['sectionMetakey']->value;?>
">
											<dfn>The main title of the page</dfn>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<div class="form-group">
												<label>Tags</label>
												<input class="form-control" placeholder="" type="text" name="sectionTags"  value="<?php echo $_smarty_tpl->tpl_vars['sectionTags']->value;?>
">
												<dfn>The main title of the page</dfn>
											</div>
										</div>
...
" value="<?php echo $_smarty_tpl->tpl_vars['sectionName'.($_smarty_tpl->tpl_vars['language']->value['langcode'])]->value;?>
">
											<dfn>The main title of the page</dfn>
										</div>
										<div class="form-group">
...
"><?php echo $_smarty_tpl->tpl_vars['sectionDescrip'.($_smarty_tpl->tpl_vars['language']->value['langcode'])]->value;?>
</textarea>
											<dfn>The page content that will viewed to user</dfn>
										</div>
...
" value="<?php echo $_smarty_tpl->tpl_vars['sectionMetadisc'.($_smarty_tpl->tpl_vars['language']->value['langcode'])]->value;?>
">
											<dfn>The main title of the page</dfn>
										</div>
									</div>
...
" value="<?php echo $_smarty_tpl->tpl_vars['sectionMetakey'.($_smarty_tpl->tpl_vars['language']->value['langcode'])]->value;?>
">
											<dfn>The main title of the page</dfn>
										</div>
									</div>
...
" value="<?php echo $_smarty_tpl->tpl_vars['sectionTags'.($_smarty_tpl->tpl_vars['language']->value['langcode'])]->value;?>
">
												<dfn>The main title of the page</dfn>
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control" name="status">
												<option value="1" <?php if ($_smarty_tpl->tpl_vars['status']->value=='1') {?>selected<?php }?>>Enabled</option>
												<option value="0" <?php if ($_smarty_tpl->tpl_vars['status']->value=='0') {?>selected<?php }?>>Disabled</option>
											</select>
											<dfn>The main title of the page</dfn>
										</div>
...
"> <?php echo $_smarty_tpl->tpl_vars['i']->value['sectionName'];?>
						...
						<div class="col-md-12 tcenter" style="margin-top:20px">
							...
							<button type="button" class="btn btn-info" onClick="location.href='news.admin.php?act=sections'" >
								List sections
							</button>
							<br>
							<br>
